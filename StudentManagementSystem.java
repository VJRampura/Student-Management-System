...
public class StudentManagementSystem extends Frame implements WindowListener,ActionListener{
	...
	public 	StudentManagementSystem(){
		...
		f1.addWindowListener(this);								clr = new Color(200,255,255);	
		f1.setFont(new Font("Arial",Font.PLAIN+Font.BOLD,30));
		clr1 = new Color(201,250,250);
		...
		void loginCheck(){
			if(!tf1.getText().equals("AAA") && !tf2.getText().equals("12345")){
				notL.setText("   Invalid User Credentials");
				pass1 = false;
				notFound.setVisible(true);
			}
			else
			if(!tf1.getText().equals("AAA")){
				notL.setText("     Invalid User Id");
				pass1 = false;
				notFound.setVisible(true);
			}
			else
			if(!tf2.getText().equals("12345")){
		...
		void lastId(){
			try{
				File f1 = new File("C:\\Users\\vijay\\OneDrive\\Desktop\\Java\\StudentDta.txt");
				if(!f1.exists()){
					f1.createNewFile();
				}	
		...
		public boolean idCheck( String sId) {
			try{
				File file = new File("C:\\Users\\vijay\\OneDrive\\Desktop\\Java\\StudentDta.txt");
		...
		void dataReplace(){
			try{
				File fil = new File("C:\\Users\\vijay\\OneDrive\\Desktop\\Java\\StudentDta.txt");
